...
config.Toolbars = [
	["TBHandle", "FormatBlock", "FontName", "FontSize", "ForeColor", "BackColor", "Bold", "Italic", "UnderLine", "StrikeThrough", "JustifyLeft", "JustifyCenter", "JustifyRight", "Indent", "Outdent"],
	["UnDo", "ReDo", "Cut", "Copy", "Delete", "RemoveFormat", "SelectAll", "UnSelect", "Image", "Flash", "Media", "File", "HorizontalRule", "CreateLink", "Unlink", "Map", "Anchor", "Emot", "Art", "Maximize", "Minimize"]
];
