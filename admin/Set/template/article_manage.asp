...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="forMy forMAargin">
					<tr>
						<td width="50" align="center" bgcolor="#DBF1F7" class="forumRow">ID</td>
					    <td width="20" align="center" bgcolor="#DBF1F7" class="forumRow">&nbsp;</td>
				      <td bgcolor="#DBF1F7" class="forumRow">&nbsp;<%=db_title%>&nbsp;名称\标题</td>
...
%>
					...
					<tr <%=onTable%>>
					  ...
					  <td width="20" align="center" class="forumRow2"><input name="edit_item" type="checkbox" id="edit_item_<%=i%>" value="<%=rs("id")%>" /></td>
						<td class="forumRow2">&nbsp;<a href="article_edit.asp?id=<%=rs("id")%>">
						  <%if keyword<>"" then%>
...
<td colspan="5" align="left" class="forumRow2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><input name="edits" type="radio" id="edits" value="check" checked="checked"/> 
      审核&nbsp; 
