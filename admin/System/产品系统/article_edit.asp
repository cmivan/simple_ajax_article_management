...
<tr>
<td align="right" class="forumRow">设置：</td>
<td class="forumRow">
<!--#include file="../../Class/articles_title_setting.asp"-->
</td>
</tr>		  
...
<%end if%>
          ...
          <tr>
            <td align="right" class="forumRow">大图：</td>
            <td class="forumRow"><input name="big_pic" type="text" id="big_pic" value="<%=big_pic%>" size="45" maxlength="255" />
              <input type=button value="上传图片" onClick="showUploadDialog('image', 'article_update.big_pic', '')"></td>
          </tr>
		  
          <tr>
            <td align="right" class="forumRow">跳转地址：</td>
            <td class="forumRow"><input name="toUrl" type="text" id="toUrl" value="<%=toUrl%>" size="45" maxlength="255" />
              <span class="red">(填写该项后，文章将自动跳转)</span></td>
          </tr>
...
<td class="forumRow">
<!--#include file="../../Class/articles_editbox.asp"-->
</td>
          </tr>
