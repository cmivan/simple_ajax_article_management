...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="forMy forMAargin">
        <tr>
          <td align="center" class="forumRow"><strong>&nbsp;&nbsp;查看 <%=db_title%> </strong></td>
        </tr>
      </table>
...
&nbsp;<%=content%></td>
          ...
          <tr>
            ...
            <td class="forumRow"><span class="submit">
              <input name="submit" type="button" value="返回列表" onClick="history.back(1);" />
            </span></td>
          </tr>
        </form>
      </table>
