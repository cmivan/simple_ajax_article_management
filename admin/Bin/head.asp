<head>
<title><%=c_title%></title>
<link href="<%=Rpath%>images/style.css" rel="stylesheet" type="text/css" />
</head>
<script language="javascript">
//文件上传，弹出的窗口 js
function showUploadDialog(s_Type, s_Link, s_Thumbnail){
var arr = showModalDialog("<%=Rpath%>EditBox/fckupLoad/dialog/i_upload.htm?style=popup&type="+s_Type+"&link="+s_Link+"&thumbnail="+s_Thumbnail, window, "dialogWidth:0px;dialogHeight:0px;help:no;scroll:no;status:no");}
</script>
