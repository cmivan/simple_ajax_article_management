...
%>
					...
					<tr <%=onTable%>>
					  ...
					  <td width="25" align="center" class="forumRow2"><input name="edit_item" type="checkbox" id="edit_item_<%=i%>" value="<%=rs("id")%>" /></td>
						<td width="420" class="forumRow2">&nbsp;<a href="<%=rs("toUrl")%>" target="_blank">
						  <%if keyword<>"" then%>
...
<td width="25" align="center" class="forumRow2"><input type="checkbox" onClick="editItem(<%=i%>);"/></td>
